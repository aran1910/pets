...
local UFO = char:FindFirstChild("ParrotHeadNest")
local fly = false
...
ti(cons, game:GetService("RunService").RenderStepped:connect(function()
	...
	if fly == true then
		...
		campos = campos:lerp((o37.CFrame * CFrame.Angles(math.rad(360 - xt),math.rad(0 - yt),math.rad(90 - zt))) * CFrame.new(nvec),0.90)
		...
		if returnhome == true then
			tCf = (char:FindFirstChild("Head").CFrame + Vector3.new(0,2,-3)) * CFrame.Angles(math.rad(0),math.rad(360),math.rad(0))
		end
